...
<button class="btn btn-danger" role="button" type="submit" value="Logout">Logout</button>
		...
		<div class="konten">
			<div id="box-welcome">
				<h1>Selamat Datang Admin<br> di Website Portofolio</h1>
	...
	<div id="kedua">
		<div class="konten" id="karya">
			...
			<div class="kolom-3">
				...
				<a href="portofolio-admin.php" class="btn-lihat">Lihat</a>
			</div>

			
			<div class="kolom-3 tengah">
				<a href="portofolio2-admin.php">
					<div class="pic">
						<img src="assets/img/tumphnil-2.jpg" alt="">
					</div>
				</a>
				<p class="desc">Karya Rizal kelas 11 RPL.</p>
				<a href="portofolio2-admin.php" class="btn-lihat">Lihat</a>
			</div>

			<div class="kolom-3">
				<a href="portfolio4-admin.php">
					<div class="pic">
				...
				<a href="portofolio4-admin.php" class="btn-lihat">Lihat</a>
			</div>

			<div class="kolom-3 tengah">
				<a href="portofolio3.html">
					<div class="pic">
						<img src="assets/img/thumbnail-3.png" alt="">
					</div>
				</a>
				<p class="desc">Karya Prakerin Kelompok 3 kelas 12 RPL.</p>
				<a href="portofolio3-admin.php" class="btn-lihat">Lihat</a>
			</div>

			<div class="kolom-3">
					<a href="portofolio6-admin.php">
						<div class="pic">
							<img src="assets/img/thumbnail-5.jpg" alt="">
						</div>
					</a>
					<p class="desc">Karya Prakerin Kelompok 8 kelas 12 RPL.</p>
					<a href="portofolio6-admin.php" class="btn-lihat">Lihat</a>
			</div>	
				
			<div class="kolom-3 tengah">
				<a href="portofolio3-admin.php">
					<div class="pic">
						<img src="assets/img/thumbnail-3.png" alt="">
					</div>
				</a>
